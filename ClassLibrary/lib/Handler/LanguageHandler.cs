...
namespace ClassLibrary.lib.Handler
{
    public class LanguageHandler : XmlHandler
    {
        ...
        public string getCaption(string key)
        {
            ...
            Logger.getLogger().append("LanguageHandler.getCaption() end - return value result='" + result + "'", Level.DEBUG, Category.LIB);
            return result;
        }
        public string getMessage(string key)
        {
            ...
            Logger.getLogger().append("LanguageHandler.getMessage() end - return value result='" + result + "'", Level.DEBUG, Category.LIB);
            return result;
        }
    }
}
